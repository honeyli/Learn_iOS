...
//    UILabel *label14 = [[UILabel alloc] initWithFrame:CGRectMake(21, 600, 1, 18)];
//    label14.text = @"";
//    label14.backgroundColor = [UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:230/255.0];
...
-(void)buttonPress:(id)sender{
    ...
    //创建userDefaults的单例
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    //登录成功后吧手机号存储到userDefaults
    [userDefaults setObject:phoneNumber forKey:LoginPhoneNumber];
