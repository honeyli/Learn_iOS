...
-(void)configureCell:(UITableViewCell*)cell  forProduct:(APLProduct *)product
{
    ...
    NSString *priceing = [numberFormatter stringFromNumber:product.inToPrice];
    NSString *detailsStr = [NSString stringWithFormat:@"%@ |  %@",priceing,[product yearIntroduced].stringValue];
